...
function filterUnfundedOnly() {
    ...
    const unfundedGames = GAMES_JSON.filter(game => game.pledged < game.goal);
        ...
        // Add the filtered unfunded games to the page
...
const unfundedMessage = `A total of ${numUnfundedGames} ${numUnfundedGames === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
